...
- `native/TokenMeterClaudeOverlay.swift` owns the non-activating panel, exact Accessibility Session binding, window following, drag/collapse behavior, and context-window enrichment.
